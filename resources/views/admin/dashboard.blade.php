      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            <!--begin::Brand Image-->
            <img
              src="{{ url('public/dist/assets/img/AdminLTELogo.png') }}"
              alt="AdminLTE Logo"
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ url('public/dist/assets/img/user7-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ url('public/dist/assets/img/user5-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ url('public/dist/assets/img/user6-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
